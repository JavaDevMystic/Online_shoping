...
public class TransactionController {
    ...
    public TransactionController(CardService cardService, SessionUser sessionUser, UserCreateService userCreateService, EmailService emailService, BasketService basketService) {
    ...
    @GetMapping("/add/basket")
    public BaseResponse<BasketCurrentDto> totalMoney() {
        Long userId = sessionUser.getId();
        BasketCurrentDto basketCurrentDto = basketService.totalMoneyForUser(userId);
        return new BaseResponse<>(basketCurrentDto);
    }
    ...
    public BaseResponse<String> confirmPurchase(
        ...
        basketService.updateAddHistory(userId);
