...
import uz.pdp.myappfigma.generic.BasketMapperImpl;
...
public class BasketService {
    ...
    private final BasketMapperImpl basketMapperImpl;

    public BasketService(BasketRepository basketRepository, BasketMapper basketMapper, AuthUserRepository authUserRepository, ProductRepository productRepository, UserSession userSession, SessionUser sessionUser, BasketMapperImpl basketMapperImpl) {
        this.basketRepository = basketRepository;
        this.basketMapper = basketMapper;
        this.authUserRepository = authUserRepository;
        this.productRepository = productRepository;
        this.sessionUser = sessionUser;
        this.basketMapperImpl = basketMapperImpl;
    }
